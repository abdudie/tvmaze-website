    ...
    <>
      <div className="main-wrapper">
        <div className="topheader jumbotron">
          ...
          <h3 className="text-light text-center">Your Personal Movie Guide</h3>
        </div>
          ...
          <div className="carousel slide" id="myslider" data-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img
                  className="car-img"
                  src="https://image.tmdb.org/t/p/original/aIkG2V4UXrfkxMdJZmq30xO0QQr.jpg"
                  alt="img1"
                />
                <div className="carousel-caption">
                  <h2>Secret Headquaters</h2>
                </div>
              </div>
              <div className="carousel-item">
                ...
                />
                <div className="carousel-caption">
                  <h2 className="text-dark">Black Adam</h2>
                </div>
              </div>
              <div className="carousel-item ">
                <img
        ...
        <br />
        <form className="container card justify-content-center flex-row">
          <br />
          {arr.map((e) => {
            return (
              <>
